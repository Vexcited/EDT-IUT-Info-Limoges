    ...
    <Dialog.Root open={needRefresh()} modal={true}>
      <Dialog.Portal>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-auto">
          <Dialog.Content class="bg-[rgb(32,32,32)] rounded-lg max-w-[450px] w-full my-auto shadow-lg">
            <div class="relative flex item justify-between items-center border-b border-b-[rgb(90,90,90)] p-4 text-[rgb(220,220,220)]">
