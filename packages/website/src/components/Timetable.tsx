    ...
    return (
      <>
        ...
        <div class="flex gap-2">
          ...
          >
            <p class="text-lg font-medium">{props.lesson.type} - {props.lesson.content.type ?? "??"}</p>
            <Show when={props.lesson.content.lesson}>
              <p class="text-subgray-1">{props.lesson.content.lesson}</p>
            </Show>
